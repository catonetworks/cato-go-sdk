...
func main() {
	...
	licenseIDToAdd := os.Getenv("CATO_LICENSE_ID_TO_ADD")
	licenseIDToRemove := os.Getenv("CATO_LICENSE_ID_TO_REMOVE")
	...
	input.LicenseIDToAdd = licenseIDToAdd
	input.LicenseIDToRemove = licenseIDToRemove
	...
	licData, err := catoClient.ReplaceSiteBwLicense(ctx, accountId, input)
	if err != nil {
